...
public class HistoryQuestions extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CardView h22  = (CardView) findViewById(R.id.hist22);
        CardView h23  = (CardView) findViewById(R.id.hist23);
        CardView h24  = (CardView) findViewById(R.id.hist24);
        CardView h25  = (CardView) findViewById(R.id.hist25);
        CardView h26  = (CardView) findViewById(R.id.hist26);
        CardView h27  = (CardView) findViewById(R.id.hist27);
        CardView h28  = (CardView) findViewById(R.id.hist28);
